...
export class TasksController {
    ...
    constructor (
        ...
        private readonly deleteTaskByUseCase: DeleteTaskUseCase,
    ...
    @ApiResponse({status:HttpStatus.CREATED,description:'Creada corectamente'})
    ...
    @ApiParam({name:'id',description:'ID de la tarea(UUID)'})
    @ApiResponse({status:HttpStatus.NOT_FOUND,description:'Tarea ELiminada'})


    async delete(@Param('id')id: string){
        return this.deleteTaskByUseCase.execute(id);
    }
}