...
import { Body, Controller, Delete, Get, HttpCode, HttpStatus, Inject, Param, ParseArrayPipe, Patch, Post } from "@nestjs/common";
...
export class TasksController {
    ...
    async findOne(@Param('id',ParseArrayPipe) id: number) {
    ...
    @ApiParam({ name: 'id', description: 'ID de la tarea (UUID)' })
    async update(@Param("id",ParseArrayPipe) id: number, @Body() updateTaskDto: UpdateTaskDto) {
    ...
    async delete(@Param("id",ParseArrayPipe) id: number) {
